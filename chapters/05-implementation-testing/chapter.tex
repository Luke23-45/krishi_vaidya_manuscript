...
Separate toolchains handle model development, backend services, mobile delivery, data storage,
and report preparation. Table~\ref{tab:implementation-tools-used} catalogues the tools chosen
for each area.
