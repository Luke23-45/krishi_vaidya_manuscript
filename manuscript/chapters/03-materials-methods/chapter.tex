...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/yolo/06_system_architecture_overview.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/yolo/01_data_pipeline_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/yolo/02_training_pipeline_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/yolo/03_quantization_export_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/yolo/05_deployment_architecture_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/vlm/06_system_architecture_overview.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/vlm/01_data_pipeline_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/vlm/02_training_pipeline_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/vlm/03_inference_pipeline_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/backend/05_system_architecture_overview.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/backend/01_api_routing_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/backend/03_data_models_persistence_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/vlm/04_api_gateway_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/backend/02_diagnosis_pipeline_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/backend/04_auth_user_management_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/mobile_app/05_system_architecture_overview.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/mobile_app/01_user_navigation_routing_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/mobile_app/03_offline_sync_data_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/mobile_app/02_scan_pipeline_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/mobile_app/04_ondevice_ml_inference_flow.pdf}
\caption{Mobile on-device ML inference flow showing model selection, load fallback, runtime precision switching, and benchmark support.}
\label{fig:mobile-ondevice-ml-inference-flow}
\end{figure}

One integration detail requires careful interpretation. The YOLO section describes the trained
object detector and its class taxonomy from the YOLO training assets, while the mobile TFLite
service currently defines a disease-label list in source code. The evidence does not yet prove
that the packaged mobile TFLite asset has been fully reconciled with the YOLO detector taxonomy.
For this reason, the mobile section treats TFLite support as implemented mobile inference
infrastructure and identifies model-taxonomy alignment as an integration verification item.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/00_all_flows.pdf}
...
The integration workflow is verified from source structure and contracts, but it is not yet fully
runtime-verified. Source inspection confirms the route contracts, validation checks, inference
...
rate-limit behavior. Live mobile-to-backend request examples, emulator or physical-device
screenshots, measured latency, and an offline-to-online sync demonstration remain necessary
before production-readiness claims can be made.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/yolo/04_validation_evaluation_flow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{data/flow_digram_data/build/vlm/05_validation_evaluation_flow.pdf}
...
diagnosis, VLM-client, Google-advisory-client, and upload-validation path. The backend is
therefore partially automated-tested: scan behavior is well represented, while broader
route-domain tests remain necessary before full backend verification can be claimed.
...
executed mobile app test suite. Full app-level validation remains incomplete until an emulator or
physical-device run is recorded. The remaining evidence should include screen screenshots, camera
behavior, TFLite loading behavior, mobile-to-backend request timing, result-screen rendering,
offline queue behavior, and recovery after network restoration.
...
screen, and test offline-to-online recovery. Until that evidence is added, the integration
workflow is best interpreted as implemented and source-verified, not fully production-validated.
